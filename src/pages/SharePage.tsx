...
import { Flame, BookOpen, Download, Loader2, Image, BarChart3, Map, Share2 } from "lucide-react";
                        ...
                        <div className="rounded-2xl border border-border bg-app-surface p-6 space-y-4">
                            ...
                            <div className="flex gap-3">
                                <input
                                    ...
                                    className="flex-1 rounded-xl border border-border bg-app-raised px-4 py-2 text-sm text-app-text focus:outline-none focus:border-gold transition-colors"
                                    placeholder="Livro"
                                />
                                <input
                                    type="number"
                                    ...
                                    className="w-24 rounded-xl border border-border bg-app-raised px-4 py-2 text-sm text-app-text focus:outline-none focus:border-gold transition-colors"
                                    placeholder="Cap."
                                />
                                <input
                                    type="number"
