...
export default function PlansHeroHeader() {
  return (
    <section
      ...
      className="relative mb-6 overflow-hidden rounded-2xl border border-[#382f23]/80 bg-[#161412] shadow-xl transition-all duration-300"
    >
      ...
      <div className="pointer-events-none absolute inset-y-0 right-0 w-full sm:w-[50%] md:w-[45%] overflow-hidden select-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-l from-transparent via-[#161412]/50 to-[#161412]" />
      ...
      <div className="relative z-10 px-5 sm:px-7 py-3.5 sm:py-4">
        {/* Overline superior */}
        <p className="font-mono text-[0.65rem] sm:text-[0.7rem] uppercase tracking-[0.22em] text-[#e5b869] font-medium mb-1.5">
          PLANOS DE LEITURA
        </p>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-6">
          <div>
            <h1 className="font-serif text-xl sm:text-2xl md:text-3xl font-normal tracking-tight text-[#f4efea] leading-tight">
              Caminhe com Deus todos os dias.
            </h1>
            <p className="mt-0.5 text-xs text-[#9b8e7e] font-sans leading-relaxed max-w-xl">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4.5 text-left shrink-0 pt-1 lg:pt-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="text-left">
                <p className="text-xs sm:text-sm font-semibold text-[#f4efea] leading-tight">Mais foco</p>
                <p className="text-[0.65rem] text-[#8f8272] font-mono leading-tight">na Palavra</p>
              </div>
            </div>

            <div className="hidden sm:block h-6 w-px bg-[#382f23]" />
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="text-left">
                <p className="text-xs sm:text-sm font-semibold text-[#f4efea] leading-tight">Disciplina</p>
                <p className="text-[0.65rem] text-[#8f8272] font-mono leading-tight">com propósito</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="text-left">
                <p className="text-xs sm:text-sm font-semibold text-[#f4efea] leading-tight">Crescimento</p>
                <p className="text-[0.65rem] text-[#8f8272] font-mono leading-tight">espiritual</p>
              </div>
            </div>
          </div>
        </div>
