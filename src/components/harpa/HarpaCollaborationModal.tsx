...
export default function HarpaCollaborationModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md sm:max-w-lg border-[#382f23] bg-[#161412] text-[#f5f5f0] p-6 sm:p-7 rounded-2xl sm:rounded-3xl shadow-2xl">
        <DialogHeader className="space-y-2 text-left border-b border-[#382f23]/60 pb-4">
        ...
        <div className="my-4 space-y-3.5 text-xs sm:text-sm text-[#c4b5a2] leading-relaxed">
          ...
          <div className="mt-4 p-3.5 rounded-xl border border-[#382f23] bg-[#1d1915]/70 flex items-center gap-3">
            <Mail className="w-5 h-5 text-[#e5b869] shrink-0" />
            <div className="min-w-0">
              <p className="text-[0.68rem] text-[#8f8272] uppercase font-mono">Envio de gravações</p>
              <a
                href="mailto:suporte@bibliavive.com.br?subject=Colaboração%20com%20a%20Harpa%20Cristã"
                className="text-xs text-[#e5b869] hover:underline font-medium break-all"
              >
        ...
        <div className="pt-3 border-t border-[#382f23]/60 flex justify-end">
          <button
            type="button"
